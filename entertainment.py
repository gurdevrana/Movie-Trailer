...
ironman=media.movie("IronMan 3","Tony Stark encounters a formidable foe called" 
					"the Mandarin."
                     "After failing to defeat this enemy,he embarks on a journey",
                    "https://upload.wikimedia.org/wikipedia/en/d/d5/Iron_Man_3_theatrical_poster.jpg",
                    "https://www.youtube.com/watch?v=oYSD2VQagc4")

batman=media.movie("BatMan the dark knight","Batman has a new foe,the Joker,"
                    "who is anaccomplished criminal hell-bent on "
                    "decimating Gotham City.",
                    "https://upload.wikimedia.org/wikipedia/en/8/8a/Dark_Knight.jpg",
                   "https://www.youtube.com/watch?v=EXeTwQWrcwY")

inception=media.movie("Inception","Cobb steals information from his targets by"
...
spiderman=media.movie("The amazing spiderman 2","Peter Parker fights crime "
...
thor=media.movie("thor","Thor is exiled by his father Odin, the King of Asgard,"
...
aos=media.movie("agents of shield","Agent Phil Coulson leads a team of highly skilled agents "
